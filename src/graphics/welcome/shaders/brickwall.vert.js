...
uniform float time;
        ...
        void main()	{
            ...
            float noiseInfluence = clamp(distance(_center.xy, _newFaceCenter.xy) * 0.005 - 0.2,0.0,1.0) + powerLevel * 0.4;
            ...
            float influence = max(clamp(1.0 / distance(cursorPosition, _newFaceCenter.xy) * cursorSize - 1.0,0.0,1.0), powerLevel);
